...
public class PuppyOrderFactory implements OrderProvidable {
    ...
    @Override
    public PuppyOrder createPuppyOrder(final String name, final String address, final String email, final Puppy puppy, final OrderOptions... options) {
        return new PuppyOrder.PuppyOrderBuilder(name, address, email, puppy).addOptions(options).build();
    }
}
