[![Build Status](https://api.travis-ci.org/symonk/sylenium-framework.svg?branch=master)](https://travis-ci.org/symonkselenide-testng-allure2-test-automation-framework)
